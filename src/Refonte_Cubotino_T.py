...
def import_libraries():
    ...
    import func_moves as rm                         # custom library, traslates the cuber solution string in robot movements string
...
def set_camera(expo_shift=0):
    ...
    if os_version >0 and os_version <= 10:
        from class_cameraos10 import camera
        ...
        from class_cameraos11 import camera
        width = camera.get_width()
        height = camera.get_height()
        time.sleep(1)
...
if __name__ == "__main__":
    ...
    ################    Display setting       ######################################################
    from class_Display import display as disp # sets the display object (the one on the robot)
    disp.clean_display()                    # cleans the display
    # ##############################################################################################
